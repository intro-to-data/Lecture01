...
There isn't one. Wish I could have actually seen the look on your
face. Zoom really takes the pizzazz out of practical jokes.
...
- Now let's briefly LOOK at what a lab would have looked like if I
  were an evil genius.
...
- [IMNS: Case Study and Data Basics](https://openintro-ims.netlify.app/getting-started-with-data.html#basic-stents-strokes)
    - User beware, this thing just kinda keeps going.
    - _STOP_ at `Sampling principles and strategies`.
